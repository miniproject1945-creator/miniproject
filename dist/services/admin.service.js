...
async function getAdminEventsService(id, query) {
    ...
    const events = user === null || user === void 0 ? void 0 : user.events.map((_a) => {
        var { userId, categoryId, locationId } = _a, rest = __rest(_a, ["userId", "categoryId", "locationId"]);
        return rest;
    });
...
async function getAdminEventTransactionsService(id, query) {
    ...
    const transactions = eventTransactions === null || eventTransactions === void 0 ? void 0 : eventTransactions.map((_a) => {
        var { userId, eventId, voucherId } = _a, rest = __rest(_a, ["userId", "eventId", "voucherId"]);
        return rest;
    });
...
async function getTransactionService(id, transactionId) {
    ...
    const { event } = transaction, newTransaction = __rest(transaction, ["event"]);
