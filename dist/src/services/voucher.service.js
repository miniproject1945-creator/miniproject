...
export class VoucherService {
    static async createVoucher(id, body) {
        const { discount, eventId, maxUsage, name } = Validation.validate(VoucherValidation.CREATE, body);
    ...
    static async getVouchersById(id, eventId) {
